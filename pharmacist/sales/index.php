...
// pharmacist/sales/index.php
require_once '../../includes/config.php';
require_once '../../includes/session.php';
require_once 'sales_functions.php';

// Kiểm tra đăng nhập và quyền truy cập
SessionManager::requireRole(['admin', 'pharmacist', 'pharmacist']);
...
<head>
    ...
    <!-- Custom Sales CSS -->
    <link rel="stylesheet" href="<?php echo BASE_URL; ?>pharmacist/sales/css/sales.css">
</head>
...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="<?php echo BASE_URL; ?>pharmacist/sales/" class="nav-link">Giao dịch bán hàng</a>
            </li>
        </ul>
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <?php if ($edit_sale): ?>
                            <div class="card-tools">
                                <a href="<?php echo BASE_URL; ?>pharmacist/sales/" class="btn btn-tool">
                    ...
                    <form id="saleForm" method="POST" novalidate>
                        ...
                        <div class="card-footer">
                            ...
                            <?php if ($edit_sale): ?>
                                <a href="<?php echo BASE_URL; ?>pharmacist/sales/" class="btn btn-secondary ml-2">
                                    <i class="fas fa-times"></i> Hủy
                                </a>
                            <?php else: ?>
        ...
        <tr>
            ...
            <td>
                <?php if ($sale['status'] == 'completed'): ?>
                    <a href="<?php echo BASE_URL; ?>pharmacist/sales/print_invoice.php?id=<?php echo $sale['sale_id']; ?>" 
            ...
            <td>
                <div class="btn-group btn-group-sm" role="group">
                    <a href="<?php echo BASE_URL; ?>pharmacist/sales/?action=edit&id=<?php echo $sale['sale_id']; ?>" 
                       class="btn btn-warning" title="Sửa">
                        <i class="fas fa-edit"></i>
                    </a>
                    <?php if ($sale['status'] == 'draft'): ?>
                        <a href="<?php echo BASE_URL; ?>pharmacist/sales/?action=delete&id=<?php echo $sale['sale_id']; ?>" 
...
<!-- Custom Sales JS -->
<script src="<?php echo BASE_URL; ?>pharmacist/sales/js/sales.js"></script>
