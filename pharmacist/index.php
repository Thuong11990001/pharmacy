...
<div class="wrapper">
        ...
        echo '<nav class="main-header navbar navbar-expand navbar-white navbar-light">
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="' . BASE_URL . 'pharmacist/" class="nav-link">Trang chủ</a>
                </li>
            </ul>
    ...
    if (file_exists('share/sidebar.php')) {
        ...
        echo '<aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="' . BASE_URL . 'pharmacist/" class="brand-link">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                        <li class="nav-item">
                            <a href="' . BASE_URL . 'pharmacist/" class="nav-link active">
                ...
                <div class="row">
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info">
                            ...
                            <a href="<?php echo BASE_URL; ?>pharmacist/medicines/" class="small-box-footer">
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success">
                            ...
                            <a href="<?php echo BASE_URL; ?>pharmacist/sales/" class="small-box-footer">
                                Xem chi tiết <i class="fas fa-arrow-circle-right"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-warning">
                            ...
                            <a href="<?php echo BASE_URL; ?>pharmacist/prescriptions/" class="small-box-footer">
                                Xem chi tiết <i class="fas fa-arrow-circle-right"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-danger">
                            ...
                            <a href="<?php echo BASE_URL; ?>pharmacist/controlled-drugs/" class="small-box-footer">
                                Xem chi tiết <i class="fas fa-arrow-circle-right"></i>
                            </a>
                        </div>
                    </div>
