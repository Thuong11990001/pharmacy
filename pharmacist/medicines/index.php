...
// pharmacist/medicines/index.php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($message_type === 'success') {
        ...
        header('Location: ' . BASE_URL . 'pharmacist/medicines/');
        exit();
    }
}
...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="<?php echo BASE_URL; ?>pharmacist/medicines/" class="nav-link">Thuốc</a>
            </li>
        </ul>
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <?php if ($edit_medicine): ?>
                            <div class="card-tools">
                                <a href="<?php echo BASE_URL; ?>pharmacist/medicines/" class="btn btn-tool">
                    ...
                    <form method="POST" id="medicineForm">
                        ...
                        <div class="card-footer">
                            ...
                            <?php if ($edit_medicine): ?>
                                <a href="<?php echo BASE_URL; ?>pharmacist/medicines/" class="btn btn-secondary">
                                    <i class="fas fa-times"></i> Hủy
                                </a>
                            <?php else: ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <a href="<?php echo BASE_URL; ?>pharmacist/medicines/?action=edit&id=<?php echo $medicine['id']; ?>" 
...
$(function () {
    ...
    $('.delete-medicine').click(function() {
        ...
        $('#confirmDelete').attr('href', '<?php echo BASE_URL; ?>pharmacist/medicines/?action=delete&id=' + id);
