...
// pharmacist/controlled_drugs/index.php
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo BASE_URL; ?>pharmacist/controlled-drugs/css/controlled_drug.css">
</head>
...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="<?php echo BASE_URL; ?>pharmacist/controlled_drugs/" class="nav-link">Log thuốc kiểm soát</a>
            </li>
        </ul>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>&nbsp;</label>
                                        <div>
                                            <a href="<?php echo BASE_URL; ?>pharmacist/controlled_drugs/" class="btn btn-secondary btn-block">
                                        ...
                                        <tr class="<?php echo !$log['supervisor_approved_by'] ? 'table-warning' : ''; ?>">
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm" role="group">
                                                    ...
                                                    <?php if (!$log['supervisor_approved_by'] && in_array($user_info['role'], ['admin', 'pharmacist'])): ?>
...
<script src="<?php echo BASE_URL; ?>pharmacist/controlled-drugs/js/controlled_drug.js"></script>
