...
// manager/controlled_drugs/index.php
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo BASE_URL; ?>manager/controlled-drugs/css/controlled_drug.css">
</head>
...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="<?php echo BASE_URL; ?>manager/controlled_drugs/" class="nav-link">Log thuốc kiểm soát</a>
            </li>
        </ul>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>&nbsp;</label>
                                        <div>
                                            <a href="<?php echo BASE_URL; ?>manager/controlled_drugs/" class="btn btn-secondary btn-block">
...
<script src="<?php echo BASE_URL; ?>manager/controlled-drugs/js/controlled_drug.js"></script>
