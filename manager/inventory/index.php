...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($message_type === 'success') {
        ...
        header('Location: ' . BASE_URL . 'manager/inventory/');
        exit();
    }
}
...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="<?php echo BASE_URL; ?>manager/inventory/" class="nav-link">Lô hàng</a>
            </li>
        </ul>
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <?php if ($edit_batch): ?>
                            <div class="card-tools">
                                <a href="<?php echo BASE_URL; ?>manager/inventory/" class="btn btn-tool">
                    ...
                    <form method="POST" id="batchForm">
                        ...
                        <div class="card-footer">
                            ...
                            <?php if ($edit_batch): ?>
                                <a href="<?php echo BASE_URL; ?>manager/inventory/" class="btn btn-secondary">
                                    <i class="fas fa-times"></i> Hủy
                                </a>
                            <?php else: ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <a href="<?php echo BASE_URL; ?>manager/inventory/?action=edit&id=<?php echo $batch['id']; ?>" 
...
$(function () {
    ...
    $('.delete-batch').click(function() {
        ...
        $('#batchName').text(name);
        $('#confirmDelete').attr('href', '<?php echo BASE_URL; ?>manager/inventory/?action=delete&id=' + id);
