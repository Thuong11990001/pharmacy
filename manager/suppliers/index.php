...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($message_type === 'success') {
        ...
        header('Location: ' . BASE_URL . 'manager/suppliers/');
        exit();
    }
}
...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="<?php echo BASE_URL; ?>manager/suppliers/" class="nav-link">Nhà cung cấp</a>
            </li>
        </ul>
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <?php if ($edit_supplier): ?>
                            <div class="card-tools">
                                <a href="<?php echo BASE_URL; ?>manager/suppliers/" class="btn btn-tool">
                    ...
                    <form method="POST" id="supplierForm">
                        ...
                        <div class="card-footer">
                            ...
                            <?php if ($edit_supplier): ?>
                                <a href="<?php echo BASE_URL; ?>manager/suppliers/" class="btn btn-secondary">
                                    <i class="fas fa-times"></i> Hủy
                                </a>
                            <?php else: ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <a href="<?php echo BASE_URL; ?>manager/suppliers/?action=edit&id=<?php echo $supplier['id']; ?>" 
...
$(function () {
    ...
    $('.delete-supplier').click(function() {
        ...
        $('#confirmDelete').attr('href', '<?php echo BASE_URL; ?>manager/suppliers/?action=delete&id=' + id);
