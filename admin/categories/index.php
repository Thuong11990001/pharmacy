...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="<?php echo BASE_URL; ?>admin/categories/" class="nav-link">Danh mục thuốc</a>
            </li>
        </ul>
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <?php if ($edit_category): ?>
                            <div class="card-tools">
                                <a href="<?php echo BASE_URL; ?>admin/categories/" class="btn btn-tool">
                    ...
                    <form method="POST" id="categoryForm">
                        ...
                        <div class="card-footer">
                            ...
                            <?php if ($edit_category): ?>
                                <a href="<?php echo BASE_URL; ?>admin/categories/" class="btn btn-secondary ml-2">
                                    <i class="fas fa-times"></i> Hủy
                                </a>
                            <?php else: ?>
                                        ...
                                        <tr class="<?php echo $category['parent_id'] ? 'table-info' : ''; ?>">
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm" role="group">
                                                    <a href="<?php echo BASE_URL; ?>admin/categories/?action=edit&id=<?php echo $category['id']; ?>" 
                                                       class="btn btn-warning" title="Sửa">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <?php if ($category['child_count'] == 0): ?>
                                                        <a href="<?php echo BASE_URL; ?>admin/categories/?action=delete&id=<?php echo $category['id']; ?>" 
